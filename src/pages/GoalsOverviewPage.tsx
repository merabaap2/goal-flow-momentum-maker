              ...
              <div className="space-y-2">
                {store.dreams.length > 0 ? (
                  store.dreams.map((dream: any, index: number) => (
                    <p key={index} className="text-foreground pl-4">
                      {dream.text}
                    </p>
                  ))
                ) : (
                  <p className="text-muted-foreground pl-4 italic">No bucket list items yet</p>
                )}
              </div>
            </div>

            {/* Medium Term Dreams Box */}
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {store.dreams.length > 0 && store.dreams.some((dream: any) => dream.enablers?.length > 0) ? (
                  ...
                  <p className="text-muted-foreground pl-4 italic">No medium term goals yet</p>
                )}
              </div>
            </div>

            {/* Short Term Dreams Box */}
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {store.dreams.length > 0 && store.dreams.some((dream: any) => 
                  ...
                  <p className="text-muted-foreground pl-4 italic">No short term goals yet</p>
                )}
              </div>
            </div>
          </div>
